...
#' @noRd
MQPRForest_C <- function(matX0, matY0, matXnew, taurange, quantile_level, max_num_tau, numTree, minSplit1, maxNode, mtry) {
    .Call(`_rf_MQPRForest_C`, matX0, matY0, matXnew, taurange, quantile_level, max_num_tau, numTree, minSplit1, maxNode, mtry)
}
...
CenQRForest_WW_C <- function(matZ0, matX0, matY0, matXnew, delta, tau, weight_rf, weight_censor, quantile_level, numTree, minSplit1, maxNode, mtry) {
    .Call(`_rf_CenQRForest_WW_C`, matZ0, matX0, matY0, matXnew, delta, tau, weight_rf, weight_censor, quantile_level, numTree, minSplit1, maxNode, mtry)
}
