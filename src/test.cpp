...
void speedtest(const arma::mat x, const arma::colvec y, const arma::rowvec weights,
                          const arma::colvec taurange, const double tau_min = 1e-10,
                          const double tol = 1e-14,
                          const uint maxit = 100000, const uint max_num_tau = 1000,
                          const bool use_residual = true){
...
int main(int argc, char *argv[]) {
  ...
  speedtest(X, y, weights, taurage, tau_min, tol, maxit, max_num_tau, use_residual);

  //R["X"] = qr_tau_para_diff_cpp(X, y, weights, taurage, tau_min, tol, maxit, max_num_tau, use_residual);
