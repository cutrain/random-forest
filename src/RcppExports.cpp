...
// QPRForest_C
SEXP QPRForest_C(const arma::mat& matZ0, const arma::mat& matX0, const arma::vec& matY0, const arma::mat& matXnew, const arma::vec& taurange, const arma::vec& quantile_level, uint max_num_tau, int numTree, int minSplit1, int maxNode, int mtry);
RcppExport SEXP _rf_QPRForest_C(SEXP matZ0SEXP, SEXP matX0SEXP, SEXP matY0SEXP, SEXP matXnewSEXP, SEXP taurangeSEXP, SEXP quantile_levelSEXP, SEXP max_num_tauSEXP, SEXP numTreeSEXP, SEXP minSplit1SEXP, SEXP maxNodeSEXP, SEXP mtrySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type matZ0(matZ0SEXP);
    ...
    Rcpp::traits::input_parameter< int >::type maxNode(maxNodeSEXP);
    Rcpp::traits::input_parameter< int >::type mtry(mtrySEXP);
    rcpp_result_gen = Rcpp::wrap(QPRForest_C(matZ0, matX0, matY0, matXnew, taurange, quantile_level, max_num_tau, numTree, minSplit1, maxNode, mtry));
    return rcpp_result_gen;
END_RCPP
}
// MQPRForest_C
SEXP MQPRForest_C(const arma::mat& matX0, const arma::vec& matY0, const arma::mat& matXnew, const arma::vec& taurange, const arma::vec& quantile_level, uint max_num_tau, int numTree, int minSplit1, int maxNode, int mtry);
RcppExport SEXP _rf_MQPRForest_C(SEXP matX0SEXP, SEXP matY0SEXP, SEXP matXnewSEXP, SEXP taurangeSEXP, SEXP quantile_levelSEXP, SEXP max_num_tauSEXP, SEXP numTreeSEXP, SEXP minSplit1SEXP, SEXP maxNodeSEXP, SEXP mtrySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type matX0(matX0SEXP);
    ...
    Rcpp::traits::input_parameter< int >::type maxNode(maxNodeSEXP);
    Rcpp::traits::input_parameter< int >::type mtry(mtrySEXP);
    rcpp_result_gen = Rcpp::wrap(MQPRForest_C(matX0, matY0, matXnew, taurange, quantile_level, max_num_tau, numTree, minSplit1, maxNode, mtry));
    return rcpp_result_gen;
END_RCPP
}
// CenQRForest_WW_C
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rf_QPRForest_C", (DL_FUNC) &_rf_QPRForest_C, 11},
    {"_rf_MQPRForest_C", (DL_FUNC) &_rf_MQPRForest_C, 10},
